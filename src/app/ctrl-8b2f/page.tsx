...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    Promise.all([
      fetch('/api/ctrl-8b2f/projects').then(r => r.json()) as Promise<unknown[]>,
      fetch('/api/ctrl-8b2f/services').then(r => r.json()) as Promise<unknown[]>,
      fetch('/api/ctrl-8b2f/contacts').then(r => r.json()) as Promise<unknown[]>,
      fetch('/api/ctrl-8b2f/upload').then(r => r.json()) as Promise<unknown[]>,
  ...
  const statCards = [
    { label: 'Projects', value: stats.projects, color: 'text-fv-orange', href: '/ctrl-8b2f/projects' },
    { label: 'Services', value: stats.services, color: 'text-blue-400', href: '/ctrl-8b2f/services' },
    { label: 'Contacts', value: stats.contacts, color: 'text-green-400', href: '/ctrl-8b2f/contacts' },
    { label: 'Images', value: stats.images, color: 'text-purple-400', href: '/ctrl-8b2f/images' },
  ]

  const quickActions = [
    { label: 'ADD PROJECT', href: '/ctrl-8b2f/projects/new' },
    { label: 'EDIT SERVICES', href: '/ctrl-8b2f/services' },
    { label: 'SITE CONTENT', href: '/ctrl-8b2f/site-content' },
